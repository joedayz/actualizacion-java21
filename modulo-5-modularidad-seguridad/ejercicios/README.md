...
**Demo JPMS banking** (`com.banking.*`): abre por separado
`modulo-5-modularidad-seguridad/modulos-ejemplo/pom.xml`. Toda la guía está en
`modulos-ejemplo/README.md` (un solo archivo).
